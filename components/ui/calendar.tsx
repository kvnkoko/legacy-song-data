  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          "day-outside text-muted-foreground/40 dark:text-muted-foreground/30 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
